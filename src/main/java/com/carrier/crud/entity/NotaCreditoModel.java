...
public class NotaCreditoModel implements Serializable {
    @Id
    @GeneratedValue (strategy = GenerationType.IDENTITY)
    @Column (unique = true, nullable = false)
    private Long id;//Numero de la Nota de Credito
    private String factura;//Numero de Factura Asociada a la Nota de Credito
    private String rif;
